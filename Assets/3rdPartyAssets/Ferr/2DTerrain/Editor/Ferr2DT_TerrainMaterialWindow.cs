...
public static class Ferr2DT_TerrainMaterialUtility {
	...
	public static void EditColliders(Ferr2DT_SegmentDescription desc) {
		...
		desc.PhysicsMaterial3D = (PhysicsMaterial   )EditorGUILayout.ObjectField("Physics Material 3D", desc.PhysicsMaterial3D, typeof(PhysicsMaterial),    false);
...
public class Ferr2DT_TerrainMaterialWindow : EditorWindow {
	...
	private void OnEnable() {
		wantsMouseMove = true;
	    titleContent   = new GUIContent("Ferr2D Material Editor");
