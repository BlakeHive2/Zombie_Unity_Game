...
public partial class Ferr2DT_SegmentDescription {
	...
	[SerializeField] Rect    _legacyLeftCap = default(Rect);
	...
	[SerializeField] Rect    _legacyInnerLeftCap = default(Rect);
	[SerializeField] Rect [] _innerLeftCaps = null;
	...
	[SerializeField] Rect    _legacyRightCap = default(Rect);
	...
	[SerializeField] Rect    _legacyInnerRightCap = default(Rect);
	...
	[SerializeField] float[] _bodyWeights = null;
	...
	[SerializeField] PhysicsMaterial    _physicsMaterial3D;
	#endregion
